...
public class BankAppController {
	...
	public String deposit(@ModelAttribute Transaction transaction,
			Model model) {
		restTemplate.postForEntity("http://transactionservice/transactions", 
				transaction, null);
	...
	public String withdraw(@ModelAttribute Transaction transaction,
			Model model) {
		restTemplate.postForEntity("http://transactionservice/transactions/withdraw", 
				transaction, null);
	...
	public ModelAndView getStatement(@RequestParam("offset") int offset, @RequestParam("size") int size) {
		CurrentDataSet currentDataSet = restTemplate.getForObject("http://transactionservice/transactions/statement", CurrentDataSet.class);
